...
(function()
{
    ...
    switch(url)
    {
        ...
        case "notation.html" :
            ...
            contenu += "Si l'apprenant obtient une note dans toutes les compétences spécifiques d'une compétence générale, le graphique (radar ou histogramme) pourra être affiché ( <span class='glyphicon glyphicon-stats'></span> ).<br/><br/>";
            contenu += "Chaque compétence spécifique peut également être visualisée et modifiée ( <span class='glyphicon glyphicon-list'></span> ).";
        ...
        case "competence_specifique.html" :
            ...
            contenu += "Vous pouvez ajuster la pondération de la compétence spécifique avec les boutons <span class='glyphicon glyphicon-plus-sign'></span> et <span class='glyphicon glyphicon-minus-sign'></span>, mais aussi avec le sélecteur sur la partie gauche de la page, tout en voyant directement les changements par rapport aux autres compétences spécifiques.";
            contenu += "</p></div></div>";
